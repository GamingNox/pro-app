...
export default function DashboardPage() {
  ...
  return (
    <div className="flex-1 custom-scroll bg-background">
      ...
      {/* Quick actions — NO opacity animation */}
      ...
      {/* Revenue card with chart — NO opacity animation on container */}
      <div className="px-6 pb-5">
        <div className="bg-white rounded-2xl p-5 shadow-apple">
          ...
          {/* Mini chart — only bars animate height, NOT opacity */}
      ...
      {/* Today's appointments — NO opacity animation */}
      <div className="px-6 pb-5">
      ...
      <div className="px-6 pb-8">
        <div className="grid grid-cols-3 gap-2">
          {[
            ...
            <div key={i} className="bg-white rounded-xl p-3 text-center shadow-sm-apple">
